...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ConnectSDKWatch",
            url: "https://dl.cloudsmith.io/QQ43WPa2Y7VlFUM3/proglove/markconnectiossdk-prod/raw/names/ConnectSDKWatch-1.1.0.xcframework/versions/1.1.0/ConnectSDKWatch-1.1.0.xcframework.zip?accept_eula=8",
